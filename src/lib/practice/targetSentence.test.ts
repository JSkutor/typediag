...
describe("targetSentence", () => {
  ...
  it("rejects sentences containing forbidden quotes and apostrophes", () => {
    // 홑따옴표가 포함된 경우
    const result1 = validateTargetSentence(
      "한글 연습 문장에 '홑따옴표'가 포함된 경우입니다.",
      1,
      100,
    );
    ...
    // 쌍따옴표가 포함된 경우
    const result2 = validateTargetSentence(
      '한글 연습 문장에 "쌍따옴표"가 포함된 경우입니다.',
      1,
      100,
    );
    ...
    const result4 = validateTargetSentence(
      "한글 연습 문장에 ’스마트아포스트로피’가 포함된 경우입니다.",
      1,
      100,
    );
