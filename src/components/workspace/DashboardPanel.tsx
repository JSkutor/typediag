    ...
    <div className="dashboard-panel glass-panel">
      ...
      <div className="mt-4 text-xs text-neutral-400 font-mono">
        ...
        <div className="flex gap-2 items-center opacity-80" aria-hidden="true">
          <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-800">Tab</kbd> <span>연습으로 복귀</span>
        </div>
        {diagnosticMode === "surface" && (
          <div className="flex gap-2 items-center mt-2 opacity-80" aria-hidden="true">
            <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-800">Click</kbd> <span>키 상세 확인</span>
          </div>
        )}
        {diagnosticMode === "cylindrical" && (
          <div className="flex gap-2 items-center mt-2 opacity-80" aria-hidden="true">
            <kbd className="px-1.5 py-0.5 rounded border border-neutral-700 bg-neutral-800">Esc</kbd> <span>전체 뷰로 복귀</span>
          </div>
        )}
      </div>
